...
public class App extends Application {
    ...
    static List<SnakeBody> snakeMove = new ArrayList<>();
    ...
    public void start(Stage primaryStage) {
        try {
            ...
            gc.fillText("Press R to Start", 100, 250);
    ...
    public static void gameEnd(GraphicsContext gc) {
        ...
        gc.fillText("Press R to restart", 50, 350);
    }
    ...
    public static void newGame(GraphicsContext gc) {
        ...
        // snake
        snake.clear();
        snake.add(new SnakeBody(6, 6, State.forward, Dir.right));
        snake.add(new SnakeBody(5, 6, State.forward, Dir.right));
        snake.add(new SnakeBody(4, 6, State.forward, Dir.right));
        newFood();
